...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://docs.roq.tech/no-invalid-page-resource',
    },
    messages: {
      missingOrExtraDefaultExport: 'Exactly one default export is expected, named as {{expectedPageName}}',
      invalidPageResource: 'Default Export name should match file name (when pascalCased). Expected {{expectedPageName}}',
    },
    schema: [],
  },
  create(context) {
