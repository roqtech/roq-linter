...
module.exports = {
  ...
  create(context) {
    ...
    const exportIdentifyingNodes = ['ExportNamedDeclaration', 'ExportDefaultDeclaration'];
    ...
    function checkForFunctionName(node) {
      if (file.extension.includes('ts') && exportIdentifyingNodes.includes(node.parent.type)) {
