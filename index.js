  ...
  configs: {
    backendConfig: {
      ...
      rules: {
        ...
        [`${pluginName}/no-invalid-filename-chars`]: 'error',
      },
    },
    frontendConfig: {
      plugins: [pluginName],
      ...
      rules: {
        ...
        [`${pluginName}/correct-export-name-components-layouts-actions`]: 'error',
    ...
    commonConfig: {
      ...
      rules:
      {
        [`${pluginName}/exports-should-follow-conventions`]: 'error',
        [`${pluginName}/dir-contains-index`]: 'error',
        [`${pluginName}/no-eslint-disable`]: 'warn',
        [`${pluginName}/no-use-deprecated-modules`]: 'error',
        [`${pluginName}/no-comments-with-no-content`]: 'error',
        [`${pluginName}/no-spaces-in-object-definition`]: 'warn',
        [`${pluginName}/name-of-class-and-function-rule`]: 'error',
